...
function getNewQuestion() {
  //set question number
  questionNumber.innerHTML = 'Запитання ' + (questionCounter + 1) + ' з 5';
...
function quizResult() {
  resultBox.querySelector('.tot-question').innerHTML = 5;
  ...
  resultBox.querySelector('.tot-score').innerHTML = correctAnswers + ' / 5';
}
